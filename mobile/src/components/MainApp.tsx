...
export function MainApp({
  ...
  const handleLogout = () => {
    if (
      confirm(t('mobile.confirm.logout', 'Do you want to disconnect and delete saved credentials?'))
    ) {
      setIsSettingsOpen(false);
      onLogout();
    }
    ...
    <div className="app-container active">
      <header className="app-header">
        <div className="app-title">
          <div className="logo-small">{t('mobile.ui.text_logo', 'AI')}</div>
          <span>{t('mobile.ui.assistant_name', 'AI Commander Assistant')}</span>
        </div>
